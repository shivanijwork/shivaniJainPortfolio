...
export default function Navbar() {
  return (
    <nav className="relative z-20 px-4 py-5 md:px-6 md:py-6">
      <div className="liquid-glass mx-auto flex container items-center justify-between rounded-full px-5 py-3 md:px-6">
        <a
          href="#hero"
          aria-label="Go to Shivani Jain hero section"
